  ...
  let extra = res.data.map((item) => {
        return `
              ...
              <img
                ...
                alt=${item.alt}
              />
              <img class="absolute w-[100px] h-[14px] object-cover bottom-1 laptop:right-[30%] tablet:right-[33%] mobileL:right-[33%] mobile:right-[40%] opacity-95" src=${item.exclusive}>
